...
echo [34mINFO[0m^|Git‚ğƒ_ƒEƒ“ƒ[ƒh‚µ‚Ä‚¢‚Ü‚·...
%CURL% -L -o %GIT_NAME% %GIT_URL%

echo [34mINFO[0m^|Git‚ğ“WŠJ‚µ‚Ä‚¢‚Ü‚·...
%GIT_NAME% -y
del %GIT_NAME%
set GIT=PortableGit\bin\git.exe

echo [34mINFO[0m^|BOT‚ÌƒvƒƒOƒ‰ƒ€‚ğƒ_ƒEƒ“ƒ[ƒh‚µ‚Ä‚¢‚Ü‚·...
%GIT% clone -b dev https://github.com/p2-3r/Style-Bert-VITS2-DiscordBot.git

echo [34mINFO[0m^|ffmpeg‚ğƒ_ƒEƒ“ƒ[ƒh‚µ‚Ä‚¢‚Ü‚·...
%CURL% -L -o %FMP_NAME% %FMP_URL%
%POWERSHELL% Expand-Archive -Path %FMP_NAME%
del %FMP_NAME%

echo [34mINFO[0m^|Python‚ğƒ_ƒEƒ“ƒ[ƒh‚µ‚Ä‚¢‚Ü‚·...
...
echo [33mCOMPLETE[0m^|ƒCƒ“ƒXƒg[ƒ‹‚ªŠ®—¹‚µ‚Ü‚µ‚½B‹N“®‚·‚é‚É‚ÍƒtƒHƒ‹ƒ_“à‚Ìbot_start.bat‚ğ‹N“®‚µ‚Ä‚­‚¾‚³‚¢B
pause
